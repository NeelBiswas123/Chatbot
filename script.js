...
input.addEventListener("keypress", function(event) {
 ...
 function chatbot(input) {
    ...
    if (input.includes("hello") || input.includes("hi")) {
      ...
      output = `No, I am just a program; I can only answer specific questions. read the readme file for  
        <a href="https://github.com/NeelBiswas123/Chatbot" target="_blank">more</a>`;
    }
